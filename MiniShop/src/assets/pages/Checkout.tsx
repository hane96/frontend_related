  ...
  return (
    <div className="bg-[#FFF7F0] pt-10 h-screen">
      <div className="flex flex-col bg-white mt-10 p-4 border mx-6 md:mx-30 rounded shadow text-[#5A3E36]">
        <h1 className="mt-2 mb-4 font-bold pl-2 md:text-xl text-[#FF8360]">
          帳單資訊
        </h1>
        ...
        <p className="text-xl font-bold mb-4 text-[#FF8360]">
          付款金額: {Math.round(total)}
        </p>
        ...
        {error && (
          <p className="text-red-600 mt-4 text-center">請先完成表單資訊</p>
        )}
      </div>
    </div>
  );
