  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row gap-4">
        <button
          onClick={toProducts}
          className="bg-[#FF8360] hover:bg-[#E66F55] px-5 py-2 font-medium text-base text-white rounded-lg shadow transition duration-200"
        >
          前往商品頁
        </button>
        {isLogin ? (
          <button
            ...
            className="bg-[#FFCCBC] hover:bg-[#FFB6A2] text-[#7F5A4F] hover:text-white px-5 py-2 rounded-lg shadow transition duration-200"
          >
            登出
          </button>
        ) : (
        ...
        <div className="fixed inset-0 bg-[#FFF7F0]/70 flex justify-center items-center z-50">
          <div className="bg-[#FFF7F0] border border-[#FFCCBC] p-7 rounded-lg shadow-md text-center">
            ...
            <div className="flex justify-center gap-4">
              <button className="px-4 py-2 bg-[#FF8360] text-white rounded hover:bg-[#E66F55]"
                onClick = {logout}
              >確定</button>
              <button className="px-4 py-2 bg-[#FFCCBC] text-gray-700 rounded hover:bg-[#FFB6A2] hover:text-white"
